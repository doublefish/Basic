...
namespace Basic.DAL
{
	...
	/// AgentUserSmsDAL
	/// </summary>
	internal class AgentUserSmsDAL : DAL<AgentUserSms>
	{
		/// <summary>
		/// 查询
		/// </summary>
		...
		/// <returns></returns>
		public AgentUserSms Get(string mobile, int type)
		{
			return Db.Queryable<AgentUserSms>().Where(o => o.Mobile == mobile && o.Type == type).OrderBy(o => o.Id, OrderByType.Desc).First();
		}
		...
		/// <returns></returns>
		public override ISugarQueryable<AgentUserSms> Query(BaseArg<AgentUserSms> arg, ISugarQueryable<AgentUserSms> query)
		{
			//代理商Id
		...
		/// <returns></returns>
		public override ISugarQueryable<AgentUserSms> Sort(ISugarQueryable<AgentUserSms> query, string orderByField, OrderByType orderByType)
		{
