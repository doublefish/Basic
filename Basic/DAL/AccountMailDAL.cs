...
namespace Basic.DAL
{
	...
	/// AccountMailDAL
	/// </summary>
	internal class AccountMailDAL : DAL<AccountMail>
	{
		/// <summary>
		/// 查询
		/// </summary>
		...
		/// <returns></returns>
		public AccountMail Get(string email, int type)
		{
			return Db.Queryable<AccountMail>().Where(o => o.Email == email && o.Type == type).First();
		}
		...
		/// <returns></returns>
		public override ISugarQueryable<AccountMail> Query(BaseArg<AccountMail> arg, ISugarQueryable<AccountMail> query)
		{
			//用户Id
		...
		/// <returns></returns>
		public override ISugarQueryable<AccountMail> Sort(ISugarQueryable<AccountMail> query, string orderByField, OrderByType orderByType)
		{
