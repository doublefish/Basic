...
namespace WebApi.Agent.Controllers
{
	...
	/// 用户短信记录
	/// </summary>
	[Route("api/User/Sms"), ApiExplorerSettings(GroupName = "user")]
	public class UserSmsController : ApiController
	{
		/// <summary>
		/// 查询
		/// </summary>
		...
		[ApiAuthorize(VerifyToken = true, VerifyRight = true)]
		[HttpGet("List/{userId?}")]
		public ReturnResult<BaseArg<AgentUserSms>> List(int? userId = null, string username = null,
