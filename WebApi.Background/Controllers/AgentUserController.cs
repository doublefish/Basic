...
namespace WebApi.Background.Controllers
{
	...
	/// 代理商用户
	/// </summary>
	[Route("api/Agent/User"), ApiExplorerSettings(GroupName = "agent")]
	public class AgentUserController : ApiController
	{
		/// <summary>
		/// 新增
		/// </summary>
		...
		[HttpPost("Add")]
		public ReturnResult<int> Add(int agentId, [FromBody] AgentUserModel model)
		{
		...
		[ApiAuthorize(VerifyToken = true, VerifyRight = true)]
		[HttpPut("Update/{id}")]
		public ReturnResult<string> Update(int id, [FromBody] AgentUserModel model)
		{
			var data = new AgentUser()
			{
				Id = id,
		...
		public ReturnResult<BaseArg<AgentUser>> List(int? agentId = null, string agentName = null,
			string username = null, string fullName = null, string mobile = null,
