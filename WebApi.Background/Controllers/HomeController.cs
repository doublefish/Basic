...
namespace WebApi.Background.Controllers
{
	...
	public class HomeController : ApiController
	{
		...
		{
			var token = LoginBLL.SignIn("User", model.Username, model.Password, Platform);
			return Json(token);
		}
		...
		[HttpGet("ListRight")]
		public ReturnResult<ICollection<Menu>> ListRight()
		{
			var results = new UserBLL(LoginInfo).ListRight(LoginInfo.Id);
			return Json(results);
		}
