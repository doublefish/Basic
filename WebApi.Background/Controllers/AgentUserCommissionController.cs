...
namespace WebApi.Background.Controllers
{
	...
	/// 代理商用户佣金
	/// </summary>
	[Route("api/Agent/User/Commission"), ApiExplorerSettings(GroupName = "agent")]
	public class AgentUserCommissionController : ApiController
	{
		/// <summary>
		/// 查询
		/// </summary>
		...
		public ReturnResult<CommissionArg<AgentUserCommission>> List(int? agentId = null, string agentName = null,
